...
Задачу ведут три сабагента под управлением главной сессии: аналитик пишет план
шага, разработчик реализует его через красные тесты, ревьюер проверяет
независимо и ничего не правит. Определения — в `.claude/agents/`, порядок и
границы ролей — в **[CLAUDE.md](CLAUDE.md)**. Обязателен на всём, кроме
тривиальной правки.
