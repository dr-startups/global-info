...
- [x] на полном прогоне `status` AI-аналитика равен `ready`, а не `fallback` —
      генеральный прогон: stage1 `APPLIED`, stage2 применён к 17 фрагментам,
      `fallbackError` 0, `fallbackValidation` 0
