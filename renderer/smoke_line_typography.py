...
#: Шаг 0114: полоса однострочного заголовка стала 700 000 вместо 950 000, и
#: карточки поднялись на 250 000 EMU; высоты и относительные положения прежние.
MATRIX_CARDS_BEFORE = [(940_000, 906_117), (1_896_117, 1_097_369)]
MATRIX_BODIES_BEFORE = [(1_294_040, 452_077), (2_250_157, 643_329)]
