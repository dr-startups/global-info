...
#:
#: С шага 0103 запас под подпись источников — её измеренная высота, а не
#: 160 000: подпись фикстуры в две строки стоит 378 700 EMU, и та же картина
#: («средний блок обрезан, „Что это значит“ уступил») требует высоты на
#: 220 000 больше. Прежние 2 200 000 отдавали средний блок целиком.
PANEL_H_TIGHT = 2_420_000
