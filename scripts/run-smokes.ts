...
export const SMOKES: Smoke[] = [
  ...
  },
  {
    ...
    tier: "full",
    about:
      "разделитель региона печатает фото раздела: ч/б, затемнённое, в пределах полей, заголовок левее панели; нет файла фото — полосы бренда; у титула одна засечка — та же у обоих вариантов",
  },
  {
