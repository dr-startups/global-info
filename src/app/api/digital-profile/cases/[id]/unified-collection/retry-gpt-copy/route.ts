/**
 * POST /api/digital-profile/cases/[id]/unified-collection/retry-gpt-copy
 * Selective GPT stage-2 retry for FALLBACK_* fragments (REMEDIATION §4.3).
...
import { retryUnifiedGptCopy } from "@/modules/digital-profile/services/unified-gpt-copy-retry";
...
export const POST = withModule(async (req: NextRequest, ctx: RouteContext) => {
  ...
  const data = await retryUnifiedGptCopy({
    caseId: id,
    jobId,
