...
export const en: Dictionary = {
  ...
  agents: {
    ...
    runUnifiedCollection: "Run full audit and build ORION Golden",
    runningUnifiedCollection: "Full audit and ORION Golden…",
    unifiedCollectionHint:
      "One job: Yandex/Serper → Arsenkin enrichment → composite → ORION Golden",
    unifiedStage: "Stage",
