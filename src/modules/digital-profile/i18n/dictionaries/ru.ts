...
export const ru: Dictionary = {
  ...
  agents: {
    ...
    runUnifiedCollection: "Запустить полный аудит и собрать ORION Golden",
    runningUnifiedCollection: "Полный аудит и ORION Golden…",
    unifiedCollectionHint:
      "Один job: Yandex/Serper → Arsenkin enrichment → composite → ORION Golden",
    unifiedStage: "Этап",
