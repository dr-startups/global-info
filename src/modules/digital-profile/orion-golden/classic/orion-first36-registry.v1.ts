...
export const ORION_FIRST36_REGISTRY_V1: First36SlotDef[] = [
  ...
  },
  {
    ...
    requiredVisual: false,
    match: {
      sectionKeys: ["01_executive_summary"],
      templates: ["orion_golden_executive_dashboard", "orion_golden_executive_card"],
    },
  },
  {
    page: 4,
    ...
    match: {
      ...
      templates: ["orion_golden_risk_matrix_grid", "orion_golden_risk_matrix"],
    },
  },
  {
    page: 5,
    ...
    match: {
      ...
      templates: ["orion_golden_profile_overview", "orion_golden_executive_card", "orion_golden_prose"],
    },
  },
  {
    page: 6,
  ...
  },
  {
    ...
    requiredVisual: false,
    match: {
      sectionKeys: ["10_ru_audit_summary"],
      templates: ["orion_golden_metrics_dashboard", "orion_golden_prose", "orion_golden_audit_dashboard"],
    },
  },
  {
    page: 8,
    ...
    requiredVisual: false,
    match: {
      sectionKeys: ["11_ru_search_links", "ru_search_results"],
      templates: ["orion_golden_metrics_dashboard", "orion_golden_prose"],
    },
  },
  {
    page: 9,
  ...
  },
  {
    ...
    requiredVisual: false,
    match: {
      sectionKeys: ["30_uae_audit_summary"],
      templates: ["orion_golden_metrics_dashboard", "orion_golden_prose", "orion_golden_audit_dashboard"],
    },
  },
  {
    ...
    requiredVisual: false,
    match: {
      sectionKeys: ["31_uae_google_search_links", "uae_search_results"],
      templates: ["orion_golden_metrics_dashboard", "orion_golden_prose"],
    },
  },
  {
