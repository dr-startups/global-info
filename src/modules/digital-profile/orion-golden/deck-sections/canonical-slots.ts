...
export const CANONICAL_BASE_SLOTS: CanonicalSlotDef[] = [
  ...
  { page: 13, slotId: "p13_ru_wikipedia", fragmentKey: "RU_IDENTITY_WIKIPEDIA", title: "Россия — Википедия", templateId: "wikipedia-knowledge" },
  ...
  { page: 29, slotId: "p29_uae_wikipedia", fragmentKey: "UAE_IDENTITY_WIKIPEDIA", title: "ОАЭ — Википедия", templateId: "wikipedia-knowledge" },
