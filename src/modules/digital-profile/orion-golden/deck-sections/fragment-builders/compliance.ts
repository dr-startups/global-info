 ...
 */
// Шаг 0114: лист стал вместительнее (полоса заголовка 700 000, нижний запас
// 800 000) — шесть худших строк сводки влезают в сцену с запасом 479 700 EMU,
// седьмая пробивает её на 145 140. Число меряется настоящей страницей смоком
// `smoke_search_table_layout.py` (Т8е1–Т8е2).
export const SUMMARY_PAGE_ROWS = 6;
