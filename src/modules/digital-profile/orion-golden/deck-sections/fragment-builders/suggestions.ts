            ...
            whyItMatters: clampClientText(
              panelStats.adverse > 0 || collectedAdverse > 0
                ...
                : panelStats.adverseOther > 0
                  ...
                  : // «Негатива нет» уже сказала строка состава числами
                    // (шаг 0135); здесь — зачем читателю этот блок.
                    "Подсказки показывают, что чаще всего ищут о субъекте: по ним видно, куда читатель пойдёт дальше.",
              320
            ),
