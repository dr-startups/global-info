...
export const GPT_SLIDE_COPY_PROMPT_VERSION = "gpt-slide-copy-v8";
...
const COPY_INSTRUCTIONS = [
  ...
  "Пиши КЛИЕНТСКИМ языком консультанта (тон ORION GSM): что увидит банк/инвестор/контрагент и почему это важно. Запрещены внутренние формулировки: «KPI», «тематический блок», «составной набор данных», «подтверждённых выводов», «из них с негативным содержанием — N» как основной текст.",
  "Для тематических bullets сохраняй многострочную структуру: 1) тема в «ёлочках», 2) 1–2 предложения смысла для клиента, 3) опционально «В корпусе: …», 4) опционально «Где видно: …», 5) опционально один «Пример: …». Не склеивай в один серый абзац и не раздувай списком доменов/заголовков.",
  "В narrative резюме начинай с вывода для проверки, затем 2–4 темы риска коротко; числа — поддержка, не склад корпуса. Финал — что делать.",
