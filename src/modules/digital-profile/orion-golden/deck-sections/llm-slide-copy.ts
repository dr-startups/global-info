...
const COPY_INSTRUCTIONS = [
  ...
  "ЗАПРЕЩЕНО оставлять или вставлять quotes, где внутри «ёлочек» только ФИО субъекта (например «Given F. Family», «Имя Фамилия») или SEO-био без риска («биография, личная жизнь, фото»). Такие строки перепиши в СУТЬ риска по title/snippet/domains из findings (санкции, суд, долг, структура владения, связанное лицо) — без новых фактов.",
