...
/** v12 — larger field budgets; never mid-cut quotes (PDF-45). */
export const GPT_SLIDE_COPY_PROMPT_VERSION = "gpt-slide-copy-v12";
...
const COPY_INSTRUCTIONS = [
  ...
  "НИКОГДА не обрывай цитату или предложение посередине и не оставляй пустые ярлыки вроде «Что делать:.» / «Всего по теме:.» — либо полная фраза, либо опусти поле.",
