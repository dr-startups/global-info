 ...
 * живом прогоне.
 */
// Шаг 0114: полоса заголовка по факту (700 000) и нижний запас 800 000 дали
// листу таблицы 4 390 200 EMU меры минус шапка 330 200. Число сверяется с мерой
// рендерера смоком `smoke_search_table_layout.py` (Т16г); лист с двухстрочным
// заголовком короче на 250 000, и его строки перекладывает мера.
export const SERP_TABLE_ROW_BUDGET_EMU = 4_060_000;
