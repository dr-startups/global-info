...
/**
 * Сколько знаков страницы едет модели (шаг 0119).
 *
 * Было 12 000. Вход чтения — около 70 % всех входных токенов прогона: страниц
 * до 120 на дело, и каждая идёт отдельным вызовом. Основание вывода — тон,
 * принадлежность, цитата — почти всегда стоит в первых абзацах, а у статьи
 * Википедии есть своя стадия разбора, которая читает её целиком.
 */
export const LINK_PAGE_MAX_CHARS = 8_000;
