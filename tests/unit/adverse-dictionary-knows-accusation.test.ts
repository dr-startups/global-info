...
describe("новые корни: что ловят и где попадаются случайно", () => {
  ...
  const MISSES: Array<[string, string]> = [
    ...
    // предлагалось бы убирать собственное раскрытие. Слово ушло из словаря
    // негатива в обеих формах и осталось ключевым словом темы владения.
    ["бенефициар — раскрытие, а не сигнал", "Бенефициаром фонда указан предприниматель"],
    ["beneficial — то же самое по-английски", "Beneficial ownership disclosure lists the founder"],
  ];
