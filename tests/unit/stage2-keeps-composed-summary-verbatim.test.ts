...
/**
 * Что вернула бы модель: сюжет переименован, и в артефакте его нет. Числа
 * черновика при этом на месте — иначе буллет отклонит гейт чисел стадии 2, и
 * проверка «легаси-резюме переписывается» померила бы не то.
 */
