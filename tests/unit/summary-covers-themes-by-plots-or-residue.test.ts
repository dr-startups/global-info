...
describe("прогон без чтения ссылок", () => {
  it("даёт ровно тот же текст, что и до шага", () => {
    ...
    expect(summary.fullText).toBe(
      // Абзац — строками (шаг 0098): вывод, перечень, подзаголовки без точки,
      // основания по строке.
      "Итоговая оценка: высокий риск.\n" +
        "Основные основания: Коррупционные и этические риски; Политические связи и публичная экспозиция.\n" +
        "Главные основания\n" +
        "Коррупционные и этические риски: Sample investigation.\n" +
        "Ограничения\n" +
        ...
        // Блок темы — строками (шаг 0097): заголовок без точки, по строке на
        // часть. Слова прежние; менялась только склейка.
        "Коррупционные и этические риски\n" +
        "По теме «Коррупционные и этические риски» найдены конкретные материалы, " +
        ...
        "Следующие проверки\n1) Подготовить единый пакет документов для KYC."
    );
  });
});
